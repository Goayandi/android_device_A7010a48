...
static wifi_error wifi_get_link_stats_dummy(wifi_request_id id,
    wifi_interface_handle iface, wifi_stats_result_handler handler);
static wifi_error wifi_set_link_stats_dummy(wifi_interface_handle iface,
    wifi_link_layer_params params);
static wifi_error wifi_clear_link_stats_dummy(wifi_interface_handle iface,
...
wifi_error init_wifi_vendor_hal_func_table(wifi_hal_fn *fn)
{
    ...
    fn->wifi_get_link_stats = wifi_get_link_stats_dummy;
    fn->wifi_set_link_stats = wifi_set_link_stats_dummy;
    fn->wifi_clear_link_stats = wifi_clear_link_stats_dummy;
...
static wifi_error wifi_get_link_stats_dummy(wifi_request_id id,
    wifi_interface_handle iface, wifi_stats_result_handler handler)
{
    ALOGI("Get link stats");
    wifi_iface_stat stat;
    memset(&stat, 0, sizeof(stat));
    handler.on_link_stats_results(id, &stat, 0, NULL);
    return WIFI_SUCCESS;
}
